...
NAME = 'semanticbits_models'
DESCRIPTION = 'you would be mu, too'
URL = 'https://email.com/mu.mewstopher/semanticbits_models'
...
setup(
    ...
    packages=find_packages(include=['semanticbits_models'],
    ...
    entry_points={
        'console_scripts': [
            'semanticbits_models=semanticbits_models.cli:main',
        ]
    },
)
